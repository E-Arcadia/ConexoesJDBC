...
public class SelecionaArquivosProperties {
	...
	public List<Path> get(String caminho) {
		...
		jfilechooser.setSelectedFiles(
				new File(caminhoInicial).listFiles(new FiltroArquivosPropriedades()));
		...
		jfilechooser.addPropertyChangeListener(new PropertyChangeListener() {
			...
			public void propertyChange(PropertyChangeEvent evt) {
				if (JFileChooser.DIRECTORY_CHANGED_PROPERTY.equals(evt.getPropertyName())) {
					...
					jFileChooser.setSelectedFiles(file.listFiles(new FiltroArquivosPropriedades()));
				}
			}
		});
	...
	public class FiltroArquivosPropriedades implements java.io.FileFilter{
		@Override
